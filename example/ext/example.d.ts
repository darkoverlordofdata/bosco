...
/** Matcher Extensions for example */
        ...
        static _matcherFinishLine;
        static FinishLine: Matcher;
...
/** Entity Extensions for example */
        static acceleratableComponent: AcceleratableComponent;
        isAcceleratable: boolean;
        setAcceleratable(value: boolean);
        static acceleratingComponent: AcceleratingComponent;
        ...
        removePosition();
        static finishLineComponent: FinishLineComponent;
