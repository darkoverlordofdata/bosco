...
event.targetTouches[0]:event;if(_this.isFullScreen){try{if(document.documentElement["requestFullscreen"])document.documentElement["requestFullscreen"]();else if(document.documentElement["mozRequestFullScreen"])document.documentElement["mozRequestFullScreen"]();else if(document.documentElement["webkitRequestFullscreen"])document.documentElement["webkitRequestFullscreen"]();else if(document.documentElement["msRequestFullscreen"])document.documentElement["msRequestFullscreen"]()}catch(e){}_this.isFullScreen=
false}_this.mouseDown=true;_this.mouseButtonDown=true;_this.mousePosition.x=parseInt(event.clientX);_this.mousePosition.y=parseInt(event.clientY);return true};this.onTouchMove=function(event){event=event.targetTouches?event.targetTouches[0]:event;_this.mousePosition.x=parseInt(event.clientX);_this.mousePosition.y=parseInt(event.clientY)};this.onTouchEnd=function(event){_this.mouseDown=false;_this.mouseButtonDown=false};document.addEventListener("touchstart",this.onTouchStart,true);document.addEventListener("touchmove",
this.onTouchMove,true);document.addEventListener("touchend",this.onTouchEnd,true);document.addEventListener("mousedown",this.onTouchStart,true);document.addEventListener("mousemove",this.onTouchMove,true);document.addEventListener("mouseup",this.onTouchEnd,true);window.addEventListener("keydown",this.onKeyDown,true);window.addEventListener("keyup",this.onKeyUp,true);if(bosco.config.fullScreen===undefined)this.isFullScreen=false;else this.isFullScreen=bosco.isMobile()||bosco.config.fullScreen}Object.defineProperty(Input,
...
false;Input._input.states={}};Input._input=new Input;return Input}();utils.Input=Input})(utils=bosco.utils||(bosco.utils={}))})(bosco||(bosco={}));var bosco;
