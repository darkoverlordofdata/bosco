...
(function(bosco){var Sprite=PIXI.Sprite;var Texture=PIXI.Texture;var Input=bosco.utils.Input;var Container=PIXI.Container;var Properties=bosco.Properties;bosco.fps=0;var _game;function controller(name){if(!bosco.config.controllers[name])return;for(var _i=0,_a=_game.controllers;_i<_a.length;_i++){var controller=_a[_i];controller.stop()}_game.controllers=[];var root=bosco.config.controllers[name];root=Array.isArray(root)?root:[root];for(var _b=0;_b<root.length;_b++){var className=root[_b];var Class=
