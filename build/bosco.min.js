...
for(var name in config.resources){var s=buildComposite(name);_prefabs[name]=s.generateTexture(renderer)}renderer.view.style.position="absolute";renderer.view.style.top="0px";renderer.view.style.left="0px";var stage=this.stage=new Container;viewContainer=this.sprites=new Container;foreContainer=this.fore=new Container;this.resize();document.body.appendChild(renderer.view);if(config.stats){var stats=this.stats=new Stats;stats.setMode(0);stats.domElement.style.position="absolute";stats.domElement.style.left=
